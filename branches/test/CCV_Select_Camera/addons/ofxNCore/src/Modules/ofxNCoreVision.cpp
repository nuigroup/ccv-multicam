...
void ofxNCoreVision::addPanels() {
	...
	ofxGuiPanel* trackingPanel = controls->addPanel(appPtr->trackingPanel, "Track", 740, 440, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
...
void ofxNCoreVision::removePanels() {
